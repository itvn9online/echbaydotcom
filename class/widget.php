...
function _eb_product_form_for_widget($instance, $field_name = array())
{
    ...
    //
    _eb_widget_echo_widget_input_checkbox($field_name['post__not_in'], $post__not_in, 'Bỏ qua chế độ lọc trùng sản phẩm theo ID, cho phép sản phẩm được hiển thị lặp lại.');
