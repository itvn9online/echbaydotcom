...
//			'li' => 'LI',
	...
	foreach ( $arr_click_add_style as $k_class => $v_class ) {
		$str_click_add_style .= '<span class="d-block"><i class="fa fa-minus-square"></i> <strong data-add="' . $field_name['custom_style'] . '" class="cur click_add_widget_class">' . $k_class . '</strong>: ' . $v_class . '</span>';
		$i_class = 1;
	}
