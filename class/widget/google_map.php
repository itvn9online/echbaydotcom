...
class ___echbay_widget_google_map extends WP_Widget
{
    ...
    function widget($args, $instance)
    {
        ...
        //
        echo '<div data-width="' . $width . '" data-height="' . $height . '" data-localtion="' . $aria_label . '" data-scrolling="' . $scrolling . '" data-zoom="' . $zoom . '" class="url-to-google-map d-none">' . $url_video . '</div>';
