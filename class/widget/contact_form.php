...
*/
class ___echbay_widget_set_contact_form extends WP_Widget {
	function __construct() {
		parent::__construct ( 'echbay_set_contact_form', 'zEchBay Contact Form', array (
				'description' => 'Tạo module liên hệ cho trang' 
		) );
	}
