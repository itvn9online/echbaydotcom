...
$eb_arr_placeholder_custom_meta_box = array(
	...
	'_eb_product_link_stylesheet' => 'Bạn có thể thêm một liên kết stylesheet vào đây, stylesheet này sẽ xuất hiện ở đầu content, dùng để tùy chỉnh CSS cho các post, page... cụ thể',
	'_eb_product_link_javascript' => 'Bạn có thể thêm một liên kết javascript vào đây, javascript này sẽ xuất hiện ở cuối content, dùng để thêm các mã javascript tùy chỉnh cho các post, page... cụ thể',
...
//	'_eb_category_primary' => 'Sử dụng khi bạn muốn các post_option sử dụng chung với category. Nếu là nhóm chính, sẽ có nhiều quyền ưu tiên hơn, VD: tạo sản phẩm liên quan...',
	...
	'_eb_category_in_list' => 'Nhóm được đánh dấu sẽ được lấy thông tin để hiển thị trong phần danh sách sản phẩm theo <strong>{tmp.slug}</strong> (chỉ cần thiết lập cho nhóm cấp 1) <span class="redcolor d-block small">* Tính năng này khá nặng web, nên không được khuyến khích sử dụng</span>',
...
if ( cf_on_off_echbay_seo == 1 ) {
	$eb_meta_custom_meta_box = array(
		...
		'_eb_product_link_javascript' => WGR_admin_lang('_eb_product_link_javascript')
