...
//	echo $main_content;
	...
	$eb_cache_note = '<!-- Plugin by ' . $arr_private_info_setting['site_upper'] . ' - Theme by WebGiaRe.org
Cached page generated by EchBay Cache (ebcache), an product of ' . $arr_private_info_setting['site_url'] . ' with https://webgiare.org/
