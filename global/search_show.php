...
$by_post_type = isset($_GET['post_type']) ? trim($_GET['post_type']) : (isset($_GET['for_post_type']) ? trim($_GET['for_post_type']) : '');
$search_not_found = '';
