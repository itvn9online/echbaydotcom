...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "hoaphat-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "hoaphat-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "hoaphat-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "hoaphat-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "hoaphat-threadnode.html";
