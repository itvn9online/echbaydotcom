...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "wondertours-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "wondertours-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "wondertours-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "wondertours-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "wondertours-threadnode.html";
