...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "guests-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "guests-footer1.php";
// Logo đối tác
...
//
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "guests-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "guests-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "guests-threadnode.html";
