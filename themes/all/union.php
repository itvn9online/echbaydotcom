...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "union-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "union-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "union-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "union-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "union-threadnode.html";
