...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "norcal-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "norcal-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "norcal-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "norcal-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "norcal-threadnode.html";
