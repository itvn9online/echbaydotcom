...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "noithatdeco-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "noithatdeco-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "noithatdeco-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "noithatdeco-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "noithatdeco-threadnode.html";
