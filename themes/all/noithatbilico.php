...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "noithatbilico-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "noithatbilico-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "noithatbilico-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "noithatbilico-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "noithatbilico-threadnode.html";
