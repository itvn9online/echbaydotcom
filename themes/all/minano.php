...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "minano-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "minano-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "minano-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "minano-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "minano-threadnode.html";
