...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "havitourist-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "havitourist-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "havitourist-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "havitourist-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "havitourist-threadnode.html";
