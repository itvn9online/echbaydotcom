...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "bepcuame-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "bepcuame-footer1.php";
// Logo đối tác
...
//
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "bepcuame-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "bepcuame-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "bepcuame-threadnode.html";
