...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "winelibrary-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "winelibrary-footer1.php";
// Logo đối tác
...
//
//$eb_all_themes_support[$eb_all_themes_name]["home"][] = "winelibrary-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "winelibrary-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "winelibrary-threadnode.html";
