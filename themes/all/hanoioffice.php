...
//
$eb_all_themes_support[$eb_all_themes_name]["top"][] = "hanoioffice-top1.php";
...
$eb_all_themes_support[$eb_all_themes_name]["footer"][] = "hanoioffice-footer1.php";
// Logo đối tác
...
//
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "hanoioffice-home1.php";
$eb_all_themes_support[$eb_all_themes_name]["home"][] = "home_widget.php";
//
$eb_all_themes_support[$eb_all_themes_name]["threaddetails"][] = "hanoioffice-threaddetails.html";
//
$eb_all_themes_support[$eb_all_themes_name]["threadnode"][] = "hanoioffice-threadnode.html";
