	...
	<div id="content-for-quick-add-menu">
		<ul class="buttom-for-quick-add-menu">
			...
			<li class="cf">
				...
				<div class="lf f20 text-center">
					<button data-link="#" data-text="<img src='<?php echo basename( WP_CONTENT_DIR ); ?>/echbaydotcom/images-global/dathongbao.png' width='200' height='76' class='dathongbao-voi-bct' />" data-target="_blank" data-rel="nofollow" type="button" class="cur click-to-add-custom-link"><i class="fa fa-plus"></i></button>
				</div>
			</li>
			<li class="cf">
				<div class="lf f80">Đã đăng ký với BCT (đỏ)</div>
				<div class="lf f20 text-center">
					<button data-link="#" data-text="<img src='<?php echo basename( WP_CONTENT_DIR ); ?>/echbaydotcom/images-global/dadangky.png' width='200' height='75' class='dadangky-voi-bct' />" data-target="_blank" data-rel="nofollow" type="button" class="cur click-to-add-custom-link"><i class="fa fa-plus"></i></button>
				</div>
			</li>
		</ul>
	</div>
