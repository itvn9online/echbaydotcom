...
<p>* Mặc định, khi bạn sử dụng Hosting của <a href="<?php echo $arr_private_info_setting['site_url']; ?>cart" target="_blank" rel="nofollow"><?php echo $arr_private_info_setting['site_upper']; ?></a> bạn sẽ được cung cấp các tính năng nâng cao, hỗ trợ việc quản trị website tốt hơn.</p>
<?php
