...
for ($i = 1; $i < 50; $i++) {
	...
	__eb_instal_demo_data($k, '', array(
		...
		'_eb_product_oldprice' => mt_rand(50, 100) * 1000,
		'_eb_product_price' => mt_rand(1, 50) * 1000,
		'_eb_product_buyer' => mt_rand(1, 50),
		'_eb_product_quantity' => 1000,

		'_eb_product_status' => mt_rand(0, 2),
	));
}
