...
//
$___eb_lang[eb_key_for_site_lang . 'home'] = 'Home';
$___eb_lang[eb_key_for_site_lang . 'widget_products_more'] = 'View more <span>&raquo;</span>';

//
$eb_note_first_lang[eb_key_for_site_lang . 'search'] = 'Search';
$___eb_lang[eb_key_for_site_lang . 'search'] = 'Search';
// placeholder for search
$___eb_lang[eb_key_for_site_lang . 'searchp'] = $___eb_lang[eb_key_for_site_lang . 'search'] . ' products';
...
//
$eb_note_first_lang[eb_key_for_site_lang . 'cart'] = 'Shopping cart';
$___eb_lang[eb_key_for_site_lang . 'cart'] = 'Shopping cart';
...
//
$eb_note_first_lang[eb_key_for_site_lang . 'taikhoan'] = 'Profile';
$___eb_lang[eb_key_for_site_lang . 'taikhoan'] = 'Profile';
$___eb_lang[eb_key_for_site_lang . 'thoat'] = 'Logout';
$___eb_lang[eb_key_for_site_lang . 'xacnhan_thoat'] = 'Comfirm logout!';
$___eb_lang[eb_key_for_site_lang . 'dangnhap'] = 'Login';
$___eb_lang[eb_key_for_site_lang . 'dangky'] = 'Register';

//
$___eb_lang[eb_key_for_site_lang . 'home_hot'] = '<i class="fa fa-dollar"></i> HOT Products';
$___eb_lang[eb_key_for_site_lang . 'home_new'] = '<i class="fa fa-star"></i> NEW Products';

//
$eb_note_first_lang[eb_key_for_site_lang . 'order_by'] = 'Products order by';
$___eb_lang[eb_key_for_site_lang . 'order_by'] = 'Order by';
$___eb_lang[eb_key_for_site_lang . 'order_view'] = 'Views';
$___eb_lang[eb_key_for_site_lang . 'order_price_down'] = 'Price down';
$___eb_lang[eb_key_for_site_lang . 'order_price_up'] = 'Price up';
$___eb_lang[eb_key_for_site_lang . 'order_az'] = 'Products name ( A-Z )';
$___eb_lang[eb_key_for_site_lang . 'order_za'] = 'Products name ( Z-A )';

//
$eb_note_first_lang[eb_key_for_site_lang . 'post_giacu'] = 'Bản dịch cứng cho trang chi tiết sản phẩm';
$___eb_lang[eb_key_for_site_lang . 'post_giacu'] = 'Old price';
$___eb_lang[eb_key_for_site_lang . 'post_giamgia'] = 'Sale<br>off';
$___eb_lang[eb_key_for_site_lang . 'post_giamoi'] = 'Price';
$___eb_lang[eb_key_for_site_lang . 'post_zero'] = '<em>Contact</em>';
$___eb_lang[eb_key_for_site_lang . 'post_luotmua'] = 'Lượt mua';
$___eb_lang[eb_key_for_site_lang . 'post_soluong'] = 'Quantity';
$___eb_lang[eb_key_for_site_lang . 'post_time_discount'] = 'Time left:';
$___eb_lang[eb_key_for_site_lang . 'post_time_soldout'] = 'Product soldout';
$___eb_lang[eb_key_for_site_lang . 'post_comment'] = 'Comment';
$___eb_lang[eb_key_for_site_lang . 'post_content'] = 'Product description';
$___eb_lang[eb_key_for_site_lang . 'post_other'] = 'Other products';
$___eb_lang[eb_key_for_site_lang . 'post_sku'] = 'SKU';
$___eb_lang[eb_key_for_site_lang . 'post_stock'] = 'Status';
$___eb_lang[eb_key_for_site_lang . 'post_instock'] = 'Instock';
$___eb_lang[eb_key_for_site_lang . 'post_outstock'] = 'Outstock';
...
//
$___eb_lang[eb_key_for_site_lang . 'thread_list_mua'] = '<i class="fa fa-shopping-cart"></i> Buy now';
$___eb_lang[eb_key_for_site_lang . 'thread_list_more'] = '<i class="fa fa-eye"></i> View';

//
$___eb_lang[eb_key_for_site_lang . 'cart_diachi'] = 'Address';
...
$___eb_lang[eb_key_for_site_lang . 'cart_dienthoai'] = 'Phone';
...
$___eb_lang[eb_key_for_site_lang . 'ads_status1'] = 'Primary banner ( 1366 x Auto )';
$___eb_lang[eb_key_for_site_lang . 'ads_status2'] = 'Wait using...';
$___eb_lang[eb_key_for_site_lang . 'ads_status3'] = $___eb_lang[eb_key_for_site_lang . 'ads_status2'];
$___eb_lang[eb_key_for_site_lang . 'ads_status4'] = 'Customer review';
$___eb_lang[eb_key_for_site_lang . 'ads_status5'] = 'Banner/ Logo đối tác ( chân trang )';
$___eb_lang[eb_key_for_site_lang . 'ads_status6'] = 'Video HOT (for home)';
$___eb_lang[eb_key_for_site_lang . 'ads_status7'] = 'Gallery/ HOT banner (for home)';
$___eb_lang[eb_key_for_site_lang . 'ads_status8'] = 'Address/ Map (for footer/ contact)';
$___eb_lang[eb_key_for_site_lang . 'ads_status9'] = 'Category banner in home';
$___eb_lang[eb_key_for_site_lang . 'ads_status10'] = 'Products slider by category (details)';
...
$___eb_lang[eb_key_for_site_lang . 'product_status7'] = 'Sold out';
...
$___eb_lang[eb_key_for_site_lang . 'product_male_gender'] = 'Male';
$___eb_lang[eb_key_for_site_lang . 'product_female_gender'] = 'Female';
$___eb_lang[eb_key_for_site_lang . 'product_unisex_gender'] = 'None';


// details
$___eb_lang[eb_key_for_site_lang . 'chitietsp'] = 'Products details';
...
$___eb_lang[eb_key_for_site_lang . 'copyright'] = 'Copyright';
$___eb_lang[eb_key_for_site_lang . 'allrights'] = ' - All rights reserved.';
$___eb_lang[eb_key_for_site_lang . 'joinus'] = 'Join us';
...
$___eb_lang[eb_key_for_site_lang . 'cart_mausac'] = 'Color';
$___eb_lang[eb_key_for_site_lang . 'cart_kichco'] = 'Size';
...
$___eb_lang[eb_key_for_site_lang . 'lh_noidung'] = 'Content';
$___eb_lang[eb_key_for_site_lang . 'lh_submit'] = 'Send contact';
...
// register
$eb_note_first_lang[eb_key_for_site_lang . 'reg_no_email'] = 'Register new account';
...
// quick register
$eb_note_first_lang[eb_key_for_site_lang . 'qreg_name'] = 'Quick register';
$___eb_lang[eb_key_for_site_lang . 'qreg_name'] = 'Full name';
$___eb_lang[eb_key_for_site_lang . 'qreg_phone'] = 'Phone';
$___eb_lang[eb_key_for_site_lang . 'qreg_email'] = 'Email';
$___eb_lang[eb_key_for_site_lang . 'qreg_submit'] = 'Send';

// profile
$eb_note_first_lang[eb_key_for_site_lang . 'pr_tonquan'] = 'Profile page';
...
$___eb_lang[eb_key_for_site_lang . 'pr_matkhau'] = 'Password';
$___eb_lang[eb_key_for_site_lang . 'pr_doimatkhau'] = 'Change password';
$___eb_lang[eb_key_for_site_lang . 'pr_hoten'] = 'Full name';
$___eb_lang[eb_key_for_site_lang . 'pr_dienthoai'] = 'Phone';
$___eb_lang[eb_key_for_site_lang . 'pr_diachi'] = 'Address';
$___eb_lang[eb_key_for_site_lang . 'pr_ngaydangky'] = 'Ngày đăng ký';
$___eb_lang[eb_key_for_site_lang . 'pr_capnhat'] = 'Update';
