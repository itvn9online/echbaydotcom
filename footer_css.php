...
if (!is_file(EB_THEME_CACHE . $cat_js_file_name) || date_time - filemtime(EB_THEME_CACHE . $cat_js_file_name) > 1800) {
...
//if ( using_child_wgr_theme == 1 && is_file( EB_CHILD_THEME_URL . 'javascript/display.js' ) ) {
