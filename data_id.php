...
$add_data_id = array(
    ...
    'logout_url' => mtv_id > 0 ? 'ebe-logout' : '',
...
<script type="text/javascript">
    <?php
    echo 'var add_data_id=' . json_encode($add_data_id) . ';' . PHP_EOL;

    //
    $data_id = array();
    foreach ($add_data_id as $k => $v) {
        $data_id[] = $k . '=add_data_id.' . $k;
    }
    echo 'var ' . implode(',', $data_id) . ';';
    ?>
</script>